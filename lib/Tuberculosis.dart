...
class Tuberculosis extends StatefulWidget {
  @override
  _HomeState createState() => _HomeState();
}

class _HomeState extends State<Tuberculosis> {
  bool _loading = true;
  late File _image;
  late List _output;
  ...
  loadModel() async {
    ...
    await Tflite.loadModel(
      model: 'assets/tbmodel.tflite',
      labels: 'assets/tblabels.txt',
    );
  }
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Center(
                    child: Text("TUBERCULOSIS DETECTOR", style: TextStyle(
                      color: Colors.white,
